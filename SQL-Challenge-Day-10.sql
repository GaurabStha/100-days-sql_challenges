-- Amazon (Medium Level) hashtag #SQL Interview Question
...
from
	amazon_transactions at1
join
	amazon_transactions at2
on
	at1.user_id = at2.user_id
and
	at2.created_at > at1.created_at
and
	at2.created_at <= at1.created_at + interval 1 week;
