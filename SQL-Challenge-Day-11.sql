-- Nvidia, Microsoft (Medium Level) hashtag #SQL Interview Question
...
-- transactions and order records by the product id in ascending 
...
select
	i.product_name,
	count(t.product_id) as number_of_transaction
from
