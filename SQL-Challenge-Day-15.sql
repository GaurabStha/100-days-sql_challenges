...
-- Find all records from days when the number of distinct users receiving
--  emails was greater than the number of distinct users sending emails.
...
on
	gge.day = ec.day
where
	ec.receiving_emails > ec.sending_emails
order by
	day;