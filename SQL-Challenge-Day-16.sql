-- JP Morgan, Chase, Bloomberg (Medium Level) hashtag #SQL Interview Question
...
and (
		time(time_stamp) <= '09:00:00'
		and
		time(time_stamp) >= '16:00:00'
		or
		day(time_stamp) not in (25, 26)
		or
		dayname(time_stamp) not in ('sunday', 'saturday'));