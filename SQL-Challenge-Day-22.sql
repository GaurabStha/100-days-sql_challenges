-- Walmart, Paypal (Medium Level) #SQL Interview Question

-- Find managers with at least 5 direct reporting employees. 
-- In situations where user is reporting to himself/herself, 
-- count that also. Output first names of managers.
...
-- FINAL QUERY -- My Solution

select
	e1.first_name as manager_first_name,
	count(e2.manager_id) as manager_rep_count
from
	employees as e1
join
	employees as e2
