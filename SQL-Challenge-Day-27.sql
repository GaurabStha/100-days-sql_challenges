-- GoldmanSachs, Deloitte (Hard Level) #SQL Interview Question
...
-- scheduled to arrive until the end of the minute it's scheduled 
-- to depart. Find the minimum number of platforms necessary to 
-- accommodate the entire scheduled traffic.

create database DeloitteDB;
use DeloitteDB;
