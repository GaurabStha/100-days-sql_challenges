...
-- Here, we first created CTE for the friends of Karl and Hans and then joined tables users,
-- and two CTEs to get the common mutual friends between Karl and Hans.
